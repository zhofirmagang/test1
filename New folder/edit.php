<?php
    include_once("../payroll/connection.php");
    ...
    {	
        ...
        if(
            ...
            //updating the table
                ...
                header("Location: edit.php#about");
            }
    }
    else{
        ...
        //     }	    // }
        //     $employee_id = $_GET['employee_id=employee_id'];	
        //     // http://gajian.com/edit.php?employee_id=emloyee_id];
        //     $employee_id = $_GET['employee_id'];
        
        $employee_id= mysqli_real_escape_string($conn, $_GET['employee_id']);
        // $employee_id=$_GET['employee_id'];
        
        $result = mysqli_query($conn, "SELECT * FROM employee WHERE employee_id=$employee_id is not null");
        while($res = mysqli_fetch_array($conn,$result))
                    ...
                    <fieldset >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4 inputGroupContainer">
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                    <input name="periode" type="text" value="<?php echo $periode; ?>">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4 inputGroupContainer">
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                    <input name="sisa_utang_jam_bulan_sebelumnya" type="text" value="<?php echo $sisa_utang_jam_bulan_sebelumnya; ?>">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4 inputGroupContainer">
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                    <input name="utang_jam_bulan_ini"  type="text" value="<?php echo $utang_jam_bulan_ini; ?>">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4 inputGroupContainer">
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                    <input name="bayar_utang_jam_bulan_ini" type="text" value="<?php echo $bayar_utang_jam_bulan_ini; ?>">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4 inputGroupContainer">
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                    <input name="sakit" type="text" value="<?php echo $sakit; ?>">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4 inputGroupContainer">
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                    <input name="telat" type="text" value="<?php echo $telat; ?>">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4 inputGroupContainer">
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                    <input name="total_shift" type="text" value="<?php echo $total_shift; ?>">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4 inputGroupContainer">
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                    <input name="gj_pokok" type="text" value="<?php echo $gj_pokok; ?>">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4 inputGroupContainer">
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                    <input name="tj_tetap" type="text" value="<?php echo $tj_tetap; ?>">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4 inputGroupContainer">
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                    <input name="tj_bpjs" type="text" value="<?php echo $tj_bpjs; ?>">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4 inputGroupContainer">
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                    <input name="lembur_mingguan" type="text" value="<?php echo $lembur_mingguan; ?>">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4 inputGroupContainer">
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                    <input name="lembur_tgl_merah" type="text" value="<?php echo $lembur_tgl_merah; ?>">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4 inputGroupContainer">
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                    <input name="pembayaran_bpjs" type="text" value="<?php echo $pembayaran_bpjs; ?>">
                                </div>
                            </div>
                        </div>
