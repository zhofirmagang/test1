                ...
                <div class="container">
                    ...
                    <form class="well form-horizontal" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post" id="contact_form">
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4 inputGroupContainer">
                                    <div class="input-group">
                                        ...
                                        <input name="employee_id" placeholder="Angka Urut" class="form-control" type="text" value="<?php echo $employee_id; ?>">
                            ...
                            <!-- Text input-->
                            <div class="form-group">
                                <label class="col-md-4 control-label">Website atau Domain</label>
                                <div class="col-md-4 inputGroupContainer">
                                    <div class="input-group">
